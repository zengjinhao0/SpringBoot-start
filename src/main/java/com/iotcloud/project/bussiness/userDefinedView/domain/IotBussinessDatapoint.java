...
public class IotBussinessDatapoint {
    private Integer id;
    ...
    public String getRelationDpCode() {
        return relationDpCode;
    }

    public void setRelationDpCode(String relationDpCode) {
        this.relationDpCode = relationDpCode == null ? null : relationDpCode.trim();
    }
    ...
    public void setReadWriteStatus(String readWriteStatus) {
        this.readWriteStatus = readWriteStatus == null ? null : readWriteStatus.trim();
    }
}